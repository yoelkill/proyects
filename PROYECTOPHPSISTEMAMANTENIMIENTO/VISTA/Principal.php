                ...
                <td colspan="2"><table width="1037"   bgcolor="#FCFCFC" border="0">
                  <tr>
                    <td height="23" colspan="8" bgcolor="#911B1B"><center>
                      <font color="#FFFFFF" size="4" face="Arial, Helvetica, sans-serif">MENU PRINCIPAL DEL SISTEMA GOOGLE</font>
                    </center></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="165">&nbsp;</td>
                    <td width="165"><br></td>
                    <td width="274"><p><a href="../CONTROLADOR/UsuarioControlador.php?op=3" ><img src="../imagenes/MANTENIMIENTOTABLAS.jpg" width="270" height="230"></a></p>
                      <p><font  size="5"><center>Mantenimiento de Tablas</center></font><br>
                      </p></td>
                    <td width="160" ><br>
                   <center></center></td>
                    <td width="160" ><br>
